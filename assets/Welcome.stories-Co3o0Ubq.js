import{r as o,j as e}from"./iframe-DKxQL3-B.js";import{C as s}from"./Card-B60ipekr.js";import{C as d}from"./CardDeck-CMNjX2OX.js";import{S as r}from"./sampleCards---KBZRPW.js";import{p as c}from"./purify.es-CEVJ7K31.js";import"./preload-helper-D9Z9MdNV.js";const b={title:"CardDeck/Docs/Welcome",parameters:{controls:{hideNoControlsWarning:!0},docs:{description:{story:"A quick interactive tour of Kreeda's Card & Deck components."}}}},t=()=>{const[i,a]=o.useState(!0);return e.jsxs("div",{style:{fontFamily:"Inter, system-ui, sans-serif",padding:20,maxWidth:1200},children:[e.jsx("h1",{style:{marginTop:0},children:"Welcome — Kreeda CardDeck"}),e.jsx("h3",{children:"Step-by-step quick start"}),e.jsxs("ol",{children:[e.jsxs("li",{children:["Open ",e.jsx("strong",{children:"CardDeck → Components → Card"})," to inspect single card variants and controls."]}),e.jsxs("li",{children:["Click ",e.jsx("strong",{children:"Reveal"})," (or press ",e.jsx("kbd",{children:"Enter"}),"/",e.jsx("kbd",{children:"Space"}),") to flip the card."]}),e.jsxs("li",{children:["Open ",e.jsx("strong",{children:"CardDeck → Components → Deck"})," to try ",e.jsx("em",{children:"Draw"}),", ",e.jsx("em",{children:"Accept"})," and ",e.jsx("em",{children:"Penalty"}),"."]}),e.jsxs("li",{children:["Open ",e.jsx("strong",{children:"CardDeck → Interactive → TwoPlayerGame"})," for the two-player demo."]}),e.jsx("li",{children:"Use the top toolbar to switch themes and the viewport menu to test mobile/tablet layouts."})]}),e.jsx("h3",{style:{marginTop:18},children:"Live examples"}),e.jsxs("div",{style:{display:"flex",gap:20,flexWrap:"wrap"},children:[e.jsxs("div",{style:{flex:"1 1 320px"},children:[e.jsx("h4",{children:"Single Card"}),e.jsx(s,{card:r[0]}),e.jsx("p",{style:{color:"#6b7280",fontSize:13},children:'Try changing the "Card" story controls to mutate props live.'})]}),e.jsxs("div",{style:{flex:"1 1 360px"},children:[e.jsx("h4",{children:"Deck (Draw / Accept / Penalty)"}),e.jsx(d,{initialCards:r,onPenalty:async n=>(await new Promise(l=>setTimeout(l,300)),{id:`pen-${Date.now()}`,title:"Penalty Card",body:`Penalty for: ${n.title??n.body??n.id}`,genericFace:{kind:"media",media:{type:"image",src:"https://picsum.photos/200/120",alt:"penalty"}}})})]})]}),e.jsx("h3",{style:{marginTop:18},children:"Sanitize HTML faces"}),e.jsxs("label",{style:{display:"flex",gap:8,alignItems:"center"},children:[e.jsx("input",{type:"checkbox",checked:i,onChange:()=>a(n=>!n)}),e.jsx("span",{style:{color:"#374151"},children:"Sanitize HTML before rendering"})]}),e.jsx("div",{style:{marginTop:10},children:e.jsx(s,{card:r.find(n=>n.genericFace?.kind==="html")??r[0],sanitizeHtml:i?n=>c.sanitize(n):void 0})}),e.jsx("h3",{style:{marginTop:18},children:"Theming & Overrides"}),e.jsxs("p",{style:{color:"#6b7280"},children:["Try the theme toolbar (top-right) to switch theme. To override in your app, set CSS variables (e.g.",e.jsx("code",{children:"--kreeda-primary"}),", ",e.jsx("code",{children:"--kreeda-card-width"}),") in global CSS."]}),e.jsx("pre",{style:{background:"#fafafa",padding:12},children:`/* example (global CSS) */
:root {
...
}`,...t.parameters?.docs?.source}}};const k=["Guide"];export{t as Guide,k as __namedExportsOrder,b as default};
